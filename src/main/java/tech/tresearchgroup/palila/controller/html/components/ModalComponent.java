...
public class ModalComponent {
    public static DomContent render(String title, DomContent body, String id) {
        return render(title, body, null, null, id);
    }

    public static DomContent render(String title, DomContent body, String apiLocation, String confirmButtonText, String id) {
        return div(
